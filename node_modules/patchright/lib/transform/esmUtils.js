...
const kExperimentalLoaderOptions = ['--no-warnings', `--experimental-loader=${_url.default.pathToFileURL(require.resolve('patchright/lib/transform/esmLoader')).toString()}`];
