...
var _zipBundle = require("patchright-core/lib/zipBundle");
...
class HtmlBuilder {
  ...
  async build(metadata, projectSuites, result, topLevelErrors) {
    ...
    // Copy app.
    const appFolder = _path.default.join(require.resolve('patchright-core'), '..', 'lib', 'vite', 'htmlReport');
    ...
    // Copy trace viewer.
    if (this._hasTraces) {
      const traceViewerFolder = _path.default.join(require.resolve('patchright-core'), '..', 'lib', 'vite', 'traceViewer');
